...
namespace FatalRust
{
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Rust", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension, ProjectTemplatesDir = @"..\..\Templates\Projects\MyCustomProject")]
    ...
    internal class MyUnconfiguredProject
    {
        ...
        /// </summary>
        internal const string ProjectExtension = "frsproj";
        ...
        /// </remarks>
        internal const string UniqueCapability = "FatalRust";

        internal const string Language = "FatalRust";
